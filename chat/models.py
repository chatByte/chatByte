...
class FriendRequest(models.Model):
    ...
    author = models.OneToOneField(User, related_name='%(class)s_author', on_delete=models.CASCADE,)
    object = models.OneToOneField(User, related_name='%(class)s_object', on_delete=models.CASCADE,)
