...
urlpatterns = [
    ...
    path("api/author/<str:AUTHOR_ID>/", api.profile_obj, name="profile_obj"),
    ...
    path(r'api/author/<str:AUTHOR_ID>/posts/',api.posts_obj, name='make_posts_obj'),
    path(r'api/author/<str:AUTHOR_ID>/posts/<str:POST_ID>/',api.post_obj, name='make_post_obj'),
    path(r'api/author/<str:AUTHOR_ID>/posts/<str:POST_ID>/comments/',api.comment_list_obj, name='comment_list_obj'),
    ...
    path(r"api/author/<str:AUTHOR_ID>/stream/", api.stream_obj, name="stream"),
    ...
    path(r"api/author/<str:AUTHOR_ID>/followers/", api.followers_obj, name="followers_obj"),
    # URL:URL: ://service/author/{AUTHOR_ID}/followers/{FOREIGN_AUTHOR_ID}
    # add a follower FOREIGN to AUTHOR
    path(r"api/author/<str:AUTHOR_ID>/followers/<str:FOREIGN_AUTHOR_ID>", api.follower_obj, name="follower_obj"),
    # http://127.0.0.1:8000/author/6/my_stream/david/1/
    path(r"get_user/<str:SERVER>/<str:AUTHOR_ID>/", views.get_user, name="get_user"),

    #Liked
    path("api/author/<str:AUTHOR_ID>/liked/", api.liked_post_obj, name="like_post"),
    ...
    #TODO ---------------------------------- ----------------------------------------------------------------
    path("api/author/<str:AUTHOR_ID>/befriend/", api.befriend, name="befriend"),

    # friends: GET
    #(get all friends of author)
    path("api/author/<str:AUTHOR_ID>/friends/", api.get_friends_obj, name = "get_friends"),

    #Get likes for a Post
    path("api/author/<str:AUTHOR_ID>/posts/<str:POST_ID>/likes/", api.likes_post_obj, name="likes_post"),
    path("api/author/<str:AUTHOR_ID>/inbox/", api.inbox, name="inbox"),

    # # Get likes for a Comment
    path("api/author/<str:AUTHOR_ID>/posts/<str:POST_ID>/comments/<str:COMMENT_ID>/likes", api.likes_comment_obj, name="likes_post_comment"),
